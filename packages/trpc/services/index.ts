...
import { getThreads, getThread, sendEmail, searchEmails, syncEmails, getStoredEmailCount } from "@repo/services/gmail/index.js";
...
export { getThreads, getThread, sendEmail, searchEmails, syncEmails, getStoredEmailCount };
